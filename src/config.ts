...
export const siteConfig: SiteConfig = {
	title: "风中闻笛",
	subtitle: "欢迎进入风中闻笛",
	siteURL: "https://kayercc.github.io/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-02-11", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bilibili: {
		vmid: "11202228", // 在此处设置你的Bilibili用户ID (vmid)，例如 "1129280784"
	...
	banner: {
		...
		homeText: {
			...
			title: "Flöte im Wind", // 主页横幅主标题

			subtitle: [
				"People who understand the limitations of their grasp are actually",
				"Better able to cherish their limited gains.",
				"Not greedy for mastery of all things",
				"But focused on what is within reach of the present.",
			],
			typewriter: {
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/kayercc",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/11202228?spm_id_from=333.1007.0.0",
					external: true,
	...
	links: [
		{
			name: "Bilibili",
			icon: "fa7-brands:bilibili",
			url: "https://space.bilibili.com/11202228?spm_id_from=333.1387.0.0",
		},
		{
			name: "Gitee",
			icon: "mdi:git",
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "Inhalt der Ankündigung", // 公告内容
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to kayercc Website!", // 欢迎词
		touch: [
			"What are you doing?",
			"Stop touching me!",
			"HENTAI!",
